...
app.config['MAIL_USERNAME'] = 'philjackson3qs@gmail.com'  # Your Gmail email address
app.config['MAIL_PASSWORD'] = 'qmmmkwfwixiybuit'  # Your Gmail password or App Password
